    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialite', models.CharField(choices=[('INFO', 'Informatique'), ('PHY', 'physique'), ('CH', 'chimie '), ('BIO', 'Biologie'), ('GEO', 'Geologie')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='etudiant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2022, 5, 16, 15, 24, 47, 428227, tzinfo=utc), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etudiant_note', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestion.etudiant')),
            ],
        ),
        migrations.CreateModel(
            name='message',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contenu', models.CharField(max_length=250)),
                ('date', models.DateField(default=datetime.datetime(2022, 5, 16, 15, 24, 47, 428227, tzinfo=utc), editable=False)),
                ('heure', models.TimeField(default=datetime.datetime(2022, 5, 16, 15, 24, 47, 428227, tzinfo=utc))),
